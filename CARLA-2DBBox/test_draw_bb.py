...
class ClientSideBoundingBoxes(object):
    ...
    def draw_bounding_boxes(display, bounding_boxes, BB = False):
        ...
        if BB:
            ...
            DR_COLOR = D_COLOR
        print("bounding_boxes in draw_bounding_boxes :{}".format(len(bounding_boxes)))
        for p2d_points in bounding_boxes:
            ...
            #print("finish p2d_points draw~~~")
        display.blit(bb_surface, [0,0])

    @staticmethod
    def draw_bounding_boxes_ver2(display, bounding_boxes, bb_surface , BB = False):
        """
        Draws bounding boxes on pygame display.
        """
...
class BasicSynchronousClient(object):
    ...
    def setup_npc(self, number_of_npc=1):
    ...
    def setup_camera(self):
        ...
        #self.camera.set_autopilot(True)
    ...
    def game_loop(self):
        ...
        try:
            ...
            while True:
                ...
                bounding_boxes, depth_patches, self.depth_dbg = ClientSideBoundingBoxes.get_bounding_boxes(walkers, self.camera, self.image, self.depth_dbg)
                #ClientSideBoundingBoxes.draw_bounding_boxes(self.display, depth_patches)
                ClientSideBoundingBoxes.draw_bounding_boxes(self.display, bounding_boxes, BB = True)
